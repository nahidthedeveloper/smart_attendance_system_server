...
# set default authentication using simple jwt
REST_FRAMEWORK = {
...
JAZZMIN_SETTINGS = {
    ...
    "search_model": ["authentication.Account"],
    ...
    "icons": {
        ...
        "authentication.Account": "fas fa-user",
    ...
    "changeform_format_overrides": {"authentication.Account": "collapsible"},
